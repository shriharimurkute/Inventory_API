...
SECRET_KEY = 'django-insecure-&@7n)zn&222_l#22w(8pe1vtgy9globhjqk&ok(+)ar6twk8gw'
...
# Add this tells Django where to look for static files within your apps
STATICFILES_DIRS = [
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # SessionAuthentication is useful for browsable API access
    ...
    # Throttling configuration (optional but good for security/scalability)
